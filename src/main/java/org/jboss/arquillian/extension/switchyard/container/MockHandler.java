...
public class MockHandler extends BaseHandler {
    ...
    private enum Behavior {
        ...
        REPLY_WITH_FAULT
    };     // reply with a specific message as fault
    ...
    private void waitFor(final LinkedBlockingQueue<Exchange> eventQueue,
        ...
        throw new SwitchYardException("Timed out waiting on event queue length to be " + numMessages + " or greater.");
    }
    ...
    private void sleep() {
        try {
            ...
            throw new SwitchYardException("Failed to sleep: " + e.getMessage());
        }
    }
}
